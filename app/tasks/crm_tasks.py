    ...
    def tarea_analisis_estrategico(self, agente, mensaje_usuario: str, contexto_chat: str, datos_acumulados: dict):
        return Task(
            description=(
                ...
                f"   - 'PEDIR_DATOS': Faltan datos críticos (email, teléfono, empresa, proyecto). Elige ESTA opción si el usuario pregunta algo pero aún no tenemos su ficha completa.\n"
                f"   - 'EJECUTAR': Tenemos TODO lo necesario para actuar en el CRM ahora.\n"
                f"   - 'RESPONDER': Solo si ya tenemos todos los datos o si es un saludo/despedida que no lleva a una venta.\n\n"
